...
struct Save0
{
    enum Flags04
    {
        ...
        DOOR_LUIGI = 1 << 11,
        DOOR_WARIO = 1 << 12,
        DOOR_MAIN_CASTLE = 1 << 13,
        DOOR_EMPTY_ROOM = 1 << 14,
        DOOR_WHOMP_FORTRESS = 1 << 15,
        DOOR_PEACH_SLIDE = 1 << 16,
        DOOR_JOLLY_ROGER = 1 << 17,
        DOOR_COOL_MOUNTAIN = 1 << 18,
        DOOR_GOOMBOSS = 1 << 19,
        DOOR_BOWSER_1 = 1 << 20,
        DOOR_BOWSER_2 = 1 << 21,
        DOOR_CASTLE_3F = 1 << 22,
    ...
    enum Flags08
    {
        ...
        UNLOCKED_LUIGI = 1 << 1,
        UNLOCKED_WARIO = 1 << 2,
        UNLOCKED_YOSHI = 1 << 3, //true by default
        
        
        
        FINISHED_OPENING_CUTSCENE = 1 << 7,
        
        FIRST_CASTLE_VISIT = 1 << 9,
        USED_WING_MARIO = 1 << 10,
        USED_BALLOON_MARIO = 1 << 11,
        USED_VANISH_LUIGI = 1 << 12,
        USED_METAL_WARIO = 1 << 13,
        USED_FIRE_YOSHI = 1 << 14,
        FIRST_RED_COIN_BOB_OMB = 1 << 15,
        TRIED_OPENING_CASTLE_DOOR = 1 << 16,
        LAKITU_TOLD_ABOUT_RABBIT_KEY = 1 << 17,
        DIRE_DOCKS_PUSHED_BACK = 1 << 18,
        POUNDED_PILLARS = 1 << 19,
        GLOWING_RABBITS = 0xff << 20,
        USED_CAP = 1 << 28
    };
    unsigned magic; //"8000"
    unsigned flags04;
    unsigned flags08;
    unsigned rabbitsCaught; //there are 28, 7 per character
    unsigned cannonsUnlocked;
